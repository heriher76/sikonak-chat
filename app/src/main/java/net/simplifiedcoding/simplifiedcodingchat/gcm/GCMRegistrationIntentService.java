...
public class GCMRegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationTokenToServer(final String token) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.PUT, URLs.URL_STORE_TOKEN,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        Log.d("token response", s.toString());
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                headers.put("Authorization", AppController.getInstance().getUserToken());
                return headers;
            }
        };
